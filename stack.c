 ...
 * @stack: the pointer to the top (stack) or bottom (queue) of a stack_t
 */
...
/**
 * init_stack - the function nitializes a stack_t stack with 
...
/**
 * check_mode - the function checks if a stack_t linked list
