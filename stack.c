 ...
 * @stack: The pointer to the top (stack)
 * or bottom (queue) of a stack_t.
 */
...
/**
 * init_stack - The function initializes a stack_t stack with
...
/**
 * check_mode - The function checks if a stack_t linked
