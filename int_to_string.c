...
/**
 * get_int - the function gets a character pointer
...
/**
 * _abs - the function gets the absolute value of an integer
...
/**
 * get_numbase_len - the function gets length of buffer needed
 * for an unsigned int
...
/**
 * fill_numbase_buff - the function fills buffer with correct numbers up to base 36
